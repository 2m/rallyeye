...
ThisBuild / libraryDependencies += compilerPlugin("com.github.ghik" % "zerowaste" % "0.2.22" cross CrossVersion.full)
...
lazy val frontend = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %%% "tapir-sttp-client"           % "1.11.1",
...
lazy val backend = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.github.arainko"           %% "ducktape"                                  % "0.2.5",
      ...
      "io.opentelemetry"             % "opentelemetry-sdk-extension-autoconfigure" % "1.42.0",
