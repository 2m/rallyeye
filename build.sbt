...
lazy val shared = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.github.iltotore"          %%% "iron-borer"       % "3.1.0"
    ),
...
lazy val frontend = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %%% "tapir-sttp-client"           % "1.11.41",
...
lazy val backend = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-client"                       % "1.11.41",
      "org.http4s"                  %% "http4s-ember-server"                       % "0.23.30",
      "org.http4s"                  %% "http4s-ember-client"                       % "0.23.30",
      "org.http4s"                  %% "http4s-otel4s-middleware-trace-client"     % "0.14.0",
      "org.http4s"                  %% "http4s-otel4s-middleware-trace-server"     % "0.14.0",
      ...
      "io.github.iltotore"          %% "iron"                                      % "3.1.0",
      "io.github.iltotore"          %% "iron-doobie"                               % "3.1.0",
      ...
      "io.github.iltotore"          %% "iron-scalacheck"                           % "3.1.0"     % Test,
