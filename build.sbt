...
lazy val frontend = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %%% "tapir-sttp-client"           % "1.13.23",
...
lazy val backend = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-client"                       % "1.13.23",
      ...
      "io.github.arturaz"           %% "otel4s-doobie"                             % "0.17.0",
      "org.typelevel"               %% "otel4s-oteljava"                           % "1.0.1",
      "org.typelevel"              %%% "otel4s-instrumentation-metrics"            % "1.0.1",
      ...
      "com.github.jatcwang"         %% "difflicious-munit"                         % "0.6.0"      % Test,
