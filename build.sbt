...
lazy val frontend = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %%% "tapir-sttp-client"           % "1.11.47",
...
lazy val backend = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-server"                       % "1.11.47",
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-client"                       % "1.11.47",
      ...
      "io.opentelemetry"             % "opentelemetry-sdk-extension-autoconfigure" % "1.54.1",
