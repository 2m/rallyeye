...
lazy val frontend = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %%% "tapir-sttp-client"           % "1.11.14",
...
lazy val backend = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-server"                       % "1.11.14",
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-client"                       % "1.11.14",
      ...
      "org.tpolecat"                %% "doobie-munit"                              % "1.0.0-RC7" % Test,
