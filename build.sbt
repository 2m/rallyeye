...
lazy val shared = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.github.iltotore"          %%% "iron-borer"       % "3.3.1"
    ),
...
lazy val frontend = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %%% "tapir-sttp-client"           % "1.13.18",
...
lazy val backend = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-client"                       % "1.13.18",
      "org.http4s"                  %% "http4s-ember-server"                       % "0.23.34",
      "org.http4s"                  %% "http4s-ember-client"                       % "0.23.34",
      "org.http4s"                  %% "http4s-otel4s-middleware-trace-client"     % "0.17.0",
      "org.http4s"                  %% "http4s-otel4s-middleware-trace-server"     % "0.17.0",
      ...
      "io.github.iltotore"          %% "iron-scalacheck"                           % "3.3.1"      % Test,
