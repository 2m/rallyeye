...
lazy val shared = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.github.iltotore"          %%% "iron-borer"       % "3.3.0"
    ),
...
lazy val frontend = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %%% "tapir-sttp-client"           % "1.13.11",
...
lazy val backend = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-server"                       % "1.13.11",
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-client"                       % "1.13.11",
      "org.http4s"                  %% "http4s-ember-server"                       % "0.23.33",
      "org.http4s"                  %% "http4s-ember-client"                       % "0.23.33",
      "org.http4s"                  %% "http4s-otel4s-middleware-trace-client"     % "0.16.0",
      "org.http4s"                  %% "http4s-otel4s-middleware-trace-server"     % "0.16.0",
      ...
      "io.opentelemetry"             % "opentelemetry-sdk-extension-autoconfigure" % "1.60.1",
