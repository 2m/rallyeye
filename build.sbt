...
lazy val shared = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.github.iltotore"          %%% "iron-borer"       % "3.2.0"
    ),
...
lazy val frontend = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %%% "tapir-sttp-client"           % "1.12.1",
...
lazy val backend = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-server"                       % "1.12.1",
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-client"                       % "1.12.1",
      ...
      "io.github.iltotore"          %% "iron"                                      % "3.2.0",
      "io.github.iltotore"          %% "iron-doobie"                               % "3.2.0",
